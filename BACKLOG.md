...
- [ ] update `run` command to use the lock file and add a `--skip-lock` flag to bypass the lock file and fetch live state from GitHub. Report on actual changes vs. already existing state.
